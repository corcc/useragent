...
function userAgent() {
    return __awaiter(this, void 0, void 0, function* () {
        const firefoxVersionsResponse = yield (0, Version_1.fetchVersion)();
        const firefoxVersions = JSON.parse(`${firefoxVersionsResponse}`);
        const { LATEST_FIREFOX_RELEASED_DEVEL_VERSION } = firefoxVersions;
        return `${(0, AppCodeName_1.appCodeName)()}/${(0, AppVersion_1.appVersion)()} (${(0, OSCpu_1.oscpu)()}; rv:${LATEST_FIREFOX_RELEASED_DEVEL_VERSION}) Gecko/${(0, ProductSub_1.productSub)()} Firefox/${LATEST_FIREFOX_RELEASED_DEVEL_VERSION}`;
    });
}
